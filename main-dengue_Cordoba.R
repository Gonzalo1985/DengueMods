...
tabla.FINAL <- rbind(tabla.training, tabla.verification)

# CORRIDA DE MODELOS
var.predictors <- c("Almc.lag2", "Tmin.Count.lag2", "Prcp.1m.lag2")

var.predictors.rf <- c("Almc.lag2", "Tmin.Count.lag2", "Prcp.2s.lag2", "HR2.lag2")

var.predictors.svm <- c("Almc.lag2")
...
print(fig)
print(KGE(data.for.print$guidance, data.for.print$observation, out.type = "full", method = "2021"))
print(NSE(data.for.print$guidance, data.for.print$observation))
print(rmse(data.for.print$guidance, data.for.print$observation))


KGE(data.for.print$randomForest.ver, data.for.print$observation)


KGE(data.for.print$supportVM.ver, data.for.print$observation)
