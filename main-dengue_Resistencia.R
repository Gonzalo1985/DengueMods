...
var.predictors <- c("HR2.lag2", "Casos.anterior", "Almc.lag2", "ETP.lag2", "Tmin.Count.lag2",
                    "Prcp.1m.lag2")

var.predictors.rf <- c("HR2.lag2", "Casos.anterior", "Almc.lag2", "ETP.lag2", "Tmin.Count.lag2",
                       "Prcp.1m.lag2")

var.predictors.svm <- c("HR2.lag2", "Casos.anterior", "Almc.lag2", "ETP.lag2", "Tmin.Count.lag2",
                        "Prcp.1m.lag2")
