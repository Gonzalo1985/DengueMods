...
saveRDS(object = mg, file = "./models/87121_multiple_lineal_model")
...
saveRDS(object = model.rf, file = "./models/87121_random_forest_model")
...
saveRDS(object = model.svm, file = "./models/87121_svm_model")
