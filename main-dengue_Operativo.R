...
Prcp.1m.Tucu <- c(0.0, 3.1, 3.1, 7.8, 7.8, 4.8, 4.7, 1.7, 11.0, 11.0, 101, 107,
                  ...
                  134.4, 109.4, 104.0, 130.0, 51.0, 52.0, 183.0, 147.70)
Prcp.1m.Resi <- c(9.0, 58.0, 58.0, 126, 118, 116, 71.0, 71.0, 43.0, 47.0, 74.2,
                  ...
                  32.0, 0.3, 80.3, 80.3, 80.3, 86.0, 6.0, 6.0, 6.3, 0.30)
Prcp.1m.Cord <- c(5.9, 5.9, 5.9, 4.0, 4.0, 4.0, 4.0, 0.0, 0.0, 0.0, 34.0,
                  ...
                  72.1, 84.1, 100.1, 91.4, 117.3, 67.0, 99.0, 117.0, 289.0, 288.30)
...
data.operativo <- data[which(data$Fecha >= "2024-07-28" & data$Fecha <= "2025-03-22"),]
...
cases.24.25 <- read_excel(paste0(path.ppal, "casos/Casos Temporada 24_25 a SE 12.xlsx"), sheet = 1)
...
final.ola.actual <- which(cases.station$ANIO_SEPI_MIN == "25/12")
...
tabla <- data.frame(Dates = seq.Date(as.Date("2024-07-28"), as.Date("2025-03-22"), 7),
...
rf.model.2 <- readRDS(paste0("./models/", station.number, "_random_forest_model_7d"))
